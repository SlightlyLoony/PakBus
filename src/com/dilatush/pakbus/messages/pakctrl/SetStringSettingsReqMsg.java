...
public class SetStringSettingsReqMsg extends AMsg {
     ...
     */
    public SetStringSettingsReqMsg( final Map<String,String> _settings, final Context _context ) {
    ...
    public SetStringSettingsReqMsg( final ByteBuffer _bytes, final Context _context ) {
        super( PROTOCOL, CODE, TYPE, _context );
