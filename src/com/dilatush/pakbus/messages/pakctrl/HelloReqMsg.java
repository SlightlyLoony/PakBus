...
/**
 * Represents a PakCtrl "Hello Request" message.
 *
 * @author Tom Dilatush  tom@dilatush.com
 */
public class HelloReqMsg extends AMsg {
    ...
    public HelloReqMsg( final int _isRouter, final int _hopMetric, final int _verifyInterval, final Context _context ) {
    ...
    public HelloReqMsg( final ByteBuffer _bytes, final Context _context ) {
        super( PROTOCOL, CODE, TYPE, _context );
